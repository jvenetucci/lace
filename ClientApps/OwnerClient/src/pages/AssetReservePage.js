...
class AssetReservePage extends Component {
  constructor(props) {
    super(props);
        this.state = {
            sku: '',
  ...
  .then(response => {
    ...
    reader.read().then((({done, value}) => {
      ...
      if(jsonObj[0] === undefined || jsonObj[0] === '') {
        document.getElementById('statusCode').innerHTML = 'Error: SKU not found.';
        return;
      }
  ...
  render() {
      return (
        <div className="AssetReservePage">
          <form onSubmit={this.handleSubmit}>
            <legend>Search for Item by SKU</legend>
...
export default AssetReservePage