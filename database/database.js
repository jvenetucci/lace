...
connection.query('CREATE TABLE IF NOT EXISTS lace.agents (name VARCHAR(40) NOT NULL, agent_public_key VARCHAR(70) NOT NULL, PRIMARY KEY (agent_public_key));', function (error, results, fields) {
